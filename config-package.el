...
(mapc
 ...
 '(flycheck flymake-easy flymake-python-pyflakes flymake-css flymake-cursor 
 	...
 	dropdown-list duplicate-thing exec-path-from-shell expand-region gist goto-chg
 	...
 	revive sass-mode shell-here smart-mode-line smex ))
